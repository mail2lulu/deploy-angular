...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LessonObjectivesComponent", function() { return LessonObjectivesComponent; });
...
function LessonObjectivesComponent_div_7_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const content_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function LessonObjectivesComponent_div_7_div_2_p_6_Template(rf, ctx) { if (rf & 1) {
...
function LessonObjectivesComponent_div_7_div_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 10);
...
function LessonObjectivesComponent_div_7_div_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 10);
...
function LessonObjectivesComponent_div_7_Template(rf, ctx) { if (rf & 1) {
...
class LessonObjectivesComponent {
    ...
    ngOnInit() {
        ...
        this.sharedModuleEventHandlerService.on(_shared_event_handler__WEBPACK_IMPORTED_MODULE_1__["sharedModuleEventHandlerType"].LESSON_OBJECTIVE_TOGGLE, data => this.display = data);
        if (this.data) {
...
LessonObjectivesComponent.ɵfac = function LessonObjectivesComponent_Factory(t) { return new (t || LessonObjectivesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_event_handler__WEBPACK_IMPORTED_MODULE_1__["SharedModuleEventHandlerService"])); };
LessonObjectivesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LessonObjectivesComponent, selectors: [["tce-web-lesson-objectives"]], inputs: { data: "data" }, decls: 8, vars: 4, consts: [[1, "mid-section"], ["id", "objective-section", 1, "objective-section"], [1, "inner-sec"], [1, "todo-sec"], [1, "text-center"], [1, "heading4", "upper-case"], ["class", "todo-list", 4, "ngFor", "ngForOf"], [1, "todo-list"], ["class", "card d-flex mb-2", 4, "ngIf"], [1, "card", "d-flex", "mb-2"], [1, "img"], ["src", "assets/images/todo-time-icon.svg"], [1, "check-icon"], ["src", "assets/images/check-green-icon.svg"], [1, "info", "body-bold-light"], [3, "ngStyle"], ["src", "assets/images/todo-video-icon.svg"], [3, "ngStyle", 4, "ngFor", "ngForOf"], ["src", "assets/images/todo-star-icon.svg"]], template: function LessonObjectivesComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LessonObjectivesModule", function() { return LessonObjectivesModule; });
/* harmony import */ var _lesson_objectives_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lesson-objectives.component */ "../../libs/lib-components/src/components/lesson-objectives/lesson-objectives.component.ts");
...
class LessonObjectivesModule {
}
LessonObjectivesModule.default = _lesson_objectives_component__WEBPACK_IMPORTED_MODULE_0__["LessonObjectivesComponent"];
LessonObjectivesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: LessonObjectivesModule });
LessonObjectivesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function LessonObjectivesModule_Factory(t) { return new (t || LessonObjectivesModule)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _shared_event_handler__WEBPACK_IMPORTED_MODULE_3__["SharedModuleEventHandlerModule"]
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](LessonObjectivesModule, { declarations: [_lesson_objectives_component__WEBPACK_IMPORTED_MODULE_0__["LessonObjectivesComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        _shared_event_handler__WEBPACK_IMPORTED_MODULE_3__["SharedModuleEventHandlerModule"]], exports: [_lesson_objectives_component__WEBPACK_IMPORTED_MODULE_0__["LessonObjectivesComponent"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LessonObjectivesModule, [{
        ...
        args: [{
                ...
                exports: [
                    _lesson_objectives_component__WEBPACK_IMPORTED_MODULE_0__["LessonObjectivesComponent"]
                ]
            }]
    }], null, null); })();
...
//# sourceMappingURL=lib-components-components-lesson-objectives-lesson-objectives-module-es2015.js.map