...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["lib-components-components-lesson-player-objectives-objectives-module"], {
  ...
  /***/
  function libsLibComponentsSrcComponentsLessonPlayerObjectivesObjectivesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ObjectivesComponent", function () {
    ...
    function ObjectivesComponent_ng_container_0_div_1_ng_container_1_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        var objective_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function ObjectivesComponent_ng_container_0_div_1_ng_container_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ObjectivesComponent_ng_container_0_div_1_ng_container_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function ObjectivesComponent_ng_container_0_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function ObjectivesComponent_ng_container_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    var ObjectivesComponent = /*#__PURE__*/function () {
      function ObjectivesComponent() {
        _classCallCheck(this, ObjectivesComponent);
      }

      _createClass(ObjectivesComponent, [{
        key: "ngOnInit",
    ...
    ObjectivesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [3, "class", 4, "ngFor", "ngForOf"]],
  ...
  /***/
  function libsLibComponentsSrcComponentsLessonPlayerObjectivesObjectivesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ObjectivesModule", function () {
    ...
    var _objectives_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./objectives.component */
    "../../libs/lib-components/src/components/lesson-player/objectives/objectives.component.ts");

    var ObjectivesModule = function ObjectivesModule() {
      _classCallCheck(this, ObjectivesModule);
    };

    ObjectivesModule["default"] = _objectives_component__WEBPACK_IMPORTED_MODULE_2__["ObjectivesComponent"];
    ObjectivesModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: ObjectivesModule
    });
    ObjectivesModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function ObjectivesModule_Factory(t) {
        return new (t || ObjectivesModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ObjectivesModule, {
        declarations: [_objectives_component__WEBPACK_IMPORTED_MODULE_2__["ObjectivesComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]],
        exports: [_objectives_component__WEBPACK_IMPORTED_MODULE_2__["ObjectivesComponent"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ObjectivesModule, [{
...
//# sourceMappingURL=lib-components-components-lesson-player-objectives-objectives-module-es5.js.map