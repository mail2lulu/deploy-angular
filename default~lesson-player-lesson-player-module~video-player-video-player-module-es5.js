...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~lesson-player-lesson-player-module~video-player-video-player-module"], {
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerComponentsCaptionCaptionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CaptionComponent", function () {
    ...
    var _note_display_note_display_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../note-display/note-display.component */
    ...
    function CaptionComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CaptionComponent_div_1_Template_div_click_0_listener() {
          ...
          return ctx_r2.onCueClicked(x_r1);
        });
    ...
    var CaptionComponent = /*#__PURE__*/function () {
      function CaptionComponent(resolver, renderer, injector, app) {
      ...
      _createClass(CaptionComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.videojs.on('timeupdate', function () {
            ...
            _this.currentTime = _this.videojs.currentTime();

            _this.currentvideodata.forEach(function (element) {
              _this.detectActionStart(element);

              _this.detectActionEnd(element.action);
            });
          });
          this.updateMarkerSubscribe = this.updateMarker.subscribe(function (e) {
            _this.currentvideodata = e;
          });
        } //---------------------------------------------------------------------------------------------------
        ...
        */
        ...
        key: "detectActionEnd",
        value: function detectActionEnd(action) {
          if (Math.floor(this.currentTime) === action.duration.to) {
            this.endPoint();
          }
        }
      }, {
        key: "detectActionStart",
        value: function detectActionStart(element) {
        ...
        key: "startCueTrigger",
        value: function startCueTrigger(currentdata) {
          this.updateCntrlOnAction(currentdata.action);
          this.cuePointTrigger.emit(currentdata);
        }
      }, {
        key: "updateCntrlOnAction",
        value: function updateCntrlOnAction(action) {
          if (action.pause) {
            this.videojs.pause();
          } else {
            this.videojs.play();
        ...
        key: "onCueClicked",
        value: function onCueClicked(currentdata) {
          this.updateCntrlOnAction(currentdata.action);
        ...
        key: "enablePlayer",
        value: function enablePlayer() {
          var element = document.querySelectorAll('.vjs-controls-disabled');
        ...
        value: function addcomponent(data) {
          var playheadWell = document.getElementsByClassName('vjs-modal-dialog-content')[2];
          var elem = this.renderer.createElement('div');
          this.renderer.appendChild(playheadWell, elem);
          var factory = this.resolver.resolveComponentFactory(this.componentType[data.action.library]);
    ...
    CaptionComponent.ɵfac = function CaptionComponent_Factory(t) {
      return new (t || CaptionComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ApplicationRef"]));
    };

    CaptionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CaptionComponent,
      selectors: [["tce-caption"]],
      inputs: {
        videojs: "videojs",
      ...
      outputs: {
        cuePointClicked: "cuePointClicked",
        cuePointTrigger: "cuePointTrigger",
        endCuePointTrigger: "endCuePointTrigger"
      },
      decls: 2,
      vars: 1,
      consts: [[1, "markerHolder"], ["class", "vjs-marker markerBox", 3, "ngStyle", "click", 4, "ngFor", "ngForOf"], [1, "vjs-marker", "markerBox", 3, "ngStyle", "click"]],
      template: function CaptionComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CaptionComponent, [{
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerComponentsNoteDisplayNoteDisplayComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NoteDisplayComponent", function () {
    ...
    var NoteDisplayComponent = /*#__PURE__*/function () {
      function NoteDisplayComponent() {
        _classCallCheck(this, NoteDisplayComponent);
      ...
      _createClass(NoteDisplayComponent, [{
        key: "getAnimClasses",
        value: function getAnimClasses() {
          var classStr = this.getCoordPos(this.currentCueVideoData.action.x) + '-' + this.getCoordPos(this.currentCueVideoData.action.y);
        ...
        key: "getCoordPos",
        value: function getCoordPos(coord) {
          var gridDistribution = [20, 60, 100]; // [20,40,60,10]

          var val = Math.floor((coord + gridDistribution[0] - 1) / (gridDistribution[1] - gridDistribution[0]));
          return val;
        }
      }]);
    ...
    NoteDisplayComponent.ɵfac = function NoteDisplayComponent_Factory(t) {
      return new (t || NoteDisplayComponent)();
    };

    NoteDisplayComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: NoteDisplayComponent,
      selectors: [["tce-note-display"]],
      inputs: {
        currentCueVideoData: "currentCueVideoData"
      },
      decls: 3,
      vars: 3,
      consts: [[1, "noteWrapper", "d-flex"], [1, "noteContent", "animated", 3, "ngStyle", "ngClass"], ["format", "html", "theme", "snow", 3, "content"]],
      template: function NoteDisplayComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerModulesVideoPlayerVideoPlayerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _components_caption_caption_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../components/caption/caption.component */
    "../../libs/lib-components/src/video-player/components/caption/caption.component.ts");
    /* harmony import */
    ...
    var _services_lrs_manager_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../services/lrs-manager.service */
    "../../libs/lib-components/src/video-player/services/lrs-manager.service.ts");
    /* harmony import */


    var _services_token_manager_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../services/token-manager.service */
    ...
    var VideoPlayerComponent = /*#__PURE__*/function () {
      function VideoPlayerComponent(resolver, renderer, injector, app, formBuilder, lrs, tokenMgr, deviceService) {
      ...
      _createClass(VideoPlayerComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.videoPlayerdata.interactiveVideo.video.files[0]) {
            this.getToken(this.videoPlayerdata.interactiveVideo.video.files[0]); // this.loadVideo(this.videoPlayerdata.interactiveVideo.video.files[0], '');
          }
        ...
        */
        ...
        value: function subscribeEvents() {
          ...
          try {
            this.playSubscribe = this.play.subscribe(function (e) {
              _this2.playerloader.play();
            });
            this.pauseSubscribe = this.pause.subscribe(function (e) {
              _this2.playerloader.pause();
            });
            this.setTimeSubscribe = this.setTime.subscribe(function (e) {
              _this2.playerloader.currentTime(e);
            });
            this.updateCueSubscribe = this.updateCue.subscribe(function (e) {
              _this2.updateMarkers.next(e); // Update marker here if it change outside of player

            });
            this.resetPlayerSubscribe = this.resetPlayer.subscribe(function (e) {
              _this2.playerloader.reset();
            });
          } catch (error) {
            console.log(error);
          }
        ...
        value: function initEvents() {
          ...
          this.playerloader.on('loadedmetadata', function () {
            _this3.addcomponent(); // this.lrs.initLrs();

          });
          this.playerloader.on('play', function () {
            _this3.addcuepoint = false;
            _this3.CreateCuePoint = false;
            _this3.pauseFlag = false;
            _this3.playFlag = false;
            _this3.blankFlag = true;
          });
          this.playerloader.on('pause', function () {
            _this3.addcuepoint = true;
            _this3.playFlag = false;
            _this3.pauseFlag = false;
            _this3.blankFlag = true;
            _this3.currenttime = _this3.playerloader.currentTime();
          });
          this.playerloader.on('timeupdate', function () {
            _this3.timeChange.emit(Math.round(_this3.playerloader.currentTime()));
          });
          this.playerloader.on('ended', function () {
            _this3.videoComplete.emit();
          });
          this.playerloader.on('loadeddata', function () {
            _this3.videoLoaded.emit();

            _this3.videoDuration.emit(_this3.playerloader.duration());
          });
          this.playerloader.on('seeked', function () {
            _this3.videoSeeked.emit(Math.round(_this3.playerloader.currentTime()));
          });
        ...
        value: function getToken(data) {
          ...
          var aclArr = data.path.split('/');
          console.log('aclArr', aclArr);
          aclArr.splice(-2, 2);
          console.log('aclArr', aclArr);
          var aclPath = aclArr.join('/');
          console.log('aclPath', aclPath);
          this.tokenMgr.getNewToken('/assets/*', 900, null).subscribe(function (resp) {
            if (resp.body.status === 'success') {
              _this4.loadVideo(_this4.videoPlayerdata.interactiveVideo.video.files[0], resp.body.token);
            }
          }, function (error) {
        ...
        key: "loadVideo",
        value: function loadVideo(data, token) {
          var _this5 = this;

          var newtrack;
          this.playerloader = videojs(this.video.nativeElement, this.videojsoptions);
          console.log(this.playerloader);
          this.playerloader.on('ready', function () {
            _this5.playerloader.src({
              src: data.path + '?hdnts=' + token,
              type: "application/x-mpegURL"
            });

            _this5.source = document.createElement('source');
            _this5.source.src = data.path + '?hdnts=' + token;
            _this5.source.type = "application/x-mpegURL";

            _this5.video.nativeElement.appendChild(_this5.source);

            _this5.videoTrack = _this5.videoPlayerdata.interactiveVideo.video.textTracks.videoTrack;

            if (_this5.videoTrack) {
              for (var index = 0; index < _this5.videoTrack.length; index++) {
                _this5.track = document.createElement('track');
                _this5.track.kind = _this5.videoTrack[index].kind;
                _this5.track.label = _this5.videoTrack[index].label;
                _this5.track.srclang = _this5.videoTrack[index].srcLang;
                _this5.track.src = _this5.videoTrack[index].video_track, _this5.track["default"] = true;
                newtrack += _this5.track;
              }

              _this5.video.nativeElement.appendChild(_this5.track);
            }
        ...
        value: function addcomponent() {
          ...
          var factory = this.resolver.resolveComponentFactory(_components_caption_caption_component__WEBPACK_IMPORTED_MODULE_2__["CaptionComponent"]);
          var elem = this.renderer.createElement('div');
          this.renderer.appendChild(playheadWell, elem);
          var ref = factory.create(this.injector, [], elem);
          ...
          var data = {
            ...
            student_id: 123,
            title: this.videoPlayerdata.interactiveVideo.video.files[0].copyright.title,
            duration: this.playerloader.duration()
          }; // this.lrs.InitVideoMux(this.playerloader.id_,data)

          ref.instance.cuePointTrigger.subscribe(function (val) {
            return _this6.cuePointTrigger.emit(val);
          });
          ref.instance.cuePointClicked.subscribe(function (val) {
            return _this6.cuePointClicked.emit(val);
          });
          ref.instance.endCuePointTrigger.subscribe(function () {
            _this6.endCuePointTrigger.emit();
          });
        ...
        value: function customplay() {
          ...
          this.playerloader.play().then(function () {}, function (err) {});
        }
      }, {
        key: "togglePause",
        value: function togglePause() {
          ...
          if (this.playerloader.paused()) {
            ...
            this.playerloader.controls(false); // this.playerloader.userActive(true);
            // if ( self.flag){ 
        ...
        key: "showCuepointForm",
        value: function showCuepointForm() {
    ...
    VideoPlayerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 0,
      consts: [[1, "video-section", "d-flex", "align-items-center", "justify-content-center", "h-100"], ["id", "video", "controls", "", "preload", "auto", "data-setup", "{}", 1, "video-js", "vjs-big-play-centered"], ["video", ""]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VideoPlayerComponent, [{
        ...
        return [{
          ...
          type: _services_lrs_manager_service__WEBPACK_IMPORTED_MODULE_4__["LrsManagerService"]
        }, {
          type: _services_token_manager_service__WEBPACK_IMPORTED_MODULE_5__["TokenManagerService"]
        }, {
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerServicesLrsManagerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LrsManagerService", function () {
      return LrsManagerService;
    });
    /* harmony import */
    ...
    var LrsManagerService = /*#__PURE__*/function () {
      function LrsManagerService() {// this.userDetails = this.user.getUserData();

        _classCallCheck(this, LrsManagerService);
      }

      _createClass(LrsManagerService, [{
        key: "initLrs",
        value: function initLrs() {
          // This line limits the number of logs in your console...
          ADL.XAPIWrapper.log.debug = true;
          var activateXAPI = true;
          console.log('this.userDetails LrsManagerService', this.userDetails); // ADL LRS Configuration - Basic Auth for demo purposes
        ...
        key: "InitVideoMux",
        value: function InitVideoMux(id, data) {
          //console.log(data);
          // Record the player init time
          var playerInitTime = Date.now(); //console.log(playerInitTime);

          var player = videojs(id); //console.log(player);
    ...
    LrsManagerService.ɵfac = function LrsManagerService_Factory(t) {
      return new (t || LrsManagerService)();
    };

    LrsManagerService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: LrsManagerService,
      factory: LrsManagerService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LrsManagerService, [{
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerServicesTokenManagerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TokenManagerService", function () {
    ...
    var TokenManagerService = /*#__PURE__*/function () {
      function TokenManagerService(http) {
        _classCallCheck(this, TokenManagerService);
      ...
      _createClass(TokenManagerService, [{
        key: "getNewToken",
        value: function getNewToken(acl, windowSeconds, url) {
          var obj = {
            acl: acl,
        ...
        key: "serviceCall",
        value: function serviceCall(url, obj) {
          return this.http.post(url, obj, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (user) {
    ...
    TokenManagerService.ɵfac = function TokenManagerService_Factory(t) {
      return new (t || TokenManagerService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    TokenManagerService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: TokenManagerService,
      factory: TokenManagerService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TokenManagerService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
  ...
  /***/
  function libsLibComponentsSrcVideoPlayerVideoPlayerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _modules_video_player_video_player_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./modules/video-player/video-player.component */
    "../../libs/lib-components/src/video-player/modules/video-player/video-player.component.ts");
    /* harmony import */


    var _components_note_display_note_display_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/note-display/note-display.component */
    "../../libs/lib-components/src/video-player/components/note-display/note-display.component.ts");
    /* harmony import */
    ...
    VideoPlayerModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], ngx_device_detector__WEBPACK_IMPORTED_MODULE_6__["DeviceDetectorModule"].forRoot(), ngx_quill__WEBPACK_IMPORTED_MODULE_5__["QuillModule"].forRoot({
        modules: {
          syntax: true,
          formula: true,
          ...
          toolbar: [['bold', 'italic', 'underline', 'strike'], ['blockquote', 'code-block'], [{
            ...
            align: []
          }], ['clean'], ['link', 'image', 'video'], ['formula', 'link']]
        }
      })]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](VideoPlayerModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], ngx_device_detector__WEBPACK_IMPORTED_MODULE_6__["DeviceDetectorModule"], ngx_quill__WEBPACK_IMPORTED_MODULE_5__["QuillModule"]],
  ...
  /***/
  function node_modulesNgxDeviceDetector__ivy_ngcc__Fesm2015NgxDeviceDetectorJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DeviceDetectorModule", function () {
    ...
    var DEVICES_RE = Object.assign({}, MOBILES_RE, TABLETS_RE, {
      FIREFOX_OS: {
    ...
    var ReTree = /*#__PURE__*/function () {
      ...
      _createClass(ReTree, [{
        key: "test",
        value: function test(string, regex) {
          var self = this;
      ...
      _createClass(DeviceDetectorService, [{
        ...
        value: function setDeviceInfo() {
          ...
          mappings.forEach(function (mapping) {
            _this7[mapping.prop] = Object.keys(Constants[mapping["const"]]).reduce(function (obj, item) {
              if (Constants[mapping["const"]][item] === 'device') {
                // hack for iOS 13 Tablet
                if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["isPlatformBrowser"])(_this7.platformId) && (!!_this7.reTree.test(_this7.userAgent, TABLETS_RE['iPad']) || navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1)) {
                  obj[Constants[mapping["const"]][item]] = 'iPad';
                  return Object;
                }
              }

              obj[Constants[mapping["const"]][item]] = _this7.reTree.test(ua, Constants["".concat(mapping["const"], "_RE")][item]);
              return obj;
            }, {});
          });
          mappings.forEach(function (mapping) {
            _this7[mapping.prop] = Object.keys(Constants[mapping["const"]]).map(function (key) {
              ...
              if (mapping.prop === 'device' && previousValue === Constants[mapping["const"]].ANDROID) {
                ...
                return _this7[mapping.prop][currentValue] ? currentValue : previousValue;
              } else {
                return previousValue === Constants[mapping["const"]].UNKNOWN && _this7[mapping.prop][currentValue] ? currentValue : previousValue;
              }
        ...
        value: function isMobile() {
          ...
          var match = Object.keys(MOBILES_RE).find(function (mobile) {
            return _this8.reTree.test(userAgent, MOBILES_RE[mobile]);
          });
          return !!match;
        }
      }, {
        ...
        value: function isTablet() {
          ...
          if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["isPlatformBrowser"])(this.platformId) && (!!this.reTree.test(this.userAgent, TABLETS_RE['iPad']) || typeof navigator !== 'undefined' && navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1)) {
            return true;
          }

          var match = Object.keys(TABLETS_RE).find(function (mobile) {
            return !!_this9.reTree.test(userAgent, TABLETS_RE[mobile]);
          });
          return !!match;
        }
      }, {
    ...
    DeviceDetectorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: DeviceDetectorService,
      factory: DeviceDetectorService.ɵfac
    });
    DeviceDetectorService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"])), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object])], DeviceDetectorService);
    var DeviceDetectorModule_1;

    var DeviceDetectorModule = DeviceDetectorModule_1 = /*#__PURE__*/function () {
      function DeviceDetectorModule() {
        _classCallCheck(this, DeviceDetectorModule);
      }

      _createClass(DeviceDetectorModule, null, [{
        key: "forRoot",
    ...
    DeviceDetectorModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DeviceDetectorModule
    });
    DeviceDetectorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DeviceDetectorModule_Factory(t) {
        return new (t || DeviceDetectorModule)();
      },
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DeviceDetectorService, [{
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DeviceDetectorModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DeviceDetectorModule, [{
...
//# sourceMappingURL=default~lesson-player-lesson-player-module~video-player-video-player-module-es5.js.map